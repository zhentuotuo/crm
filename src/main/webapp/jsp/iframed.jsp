...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            <li>
                <a href="${pageContext.request.contextPath}/jsp/indexd.jsp" class="active-menu waves-effect waves-dark"><i class="fa fa-dashboard"></i> 基本信息</a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/jsp/journal.jsp" class="waves-effect waves-dark"><i class="fa fa-desktop"></i> 日志管理</a>
            </li>
            <li>
